...
function Footer() {
    ...
    return (
        <footer className='bg-black text-white py-8 flex flex-col gap-4 items-center'>
            <a href="" className="group bg-white text-black px-8 py-4 rounded-full font-semibold inline-flex items-center gap-2 hover:bg-gray-100 transition-colors">
                Install Extension
